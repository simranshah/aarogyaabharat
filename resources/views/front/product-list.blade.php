...
<div class="new-home-hero-section">
        <nav class="new-home-breadcrumb">
            <a href="#">Home</a> / <a href="#">Blog</a> / <span>Blog Details</span>
        </nav>

        <main class="new-home-main-content">
            <h1 class="new-home-title">Home care</h1>
...
<div class="containerforfilters">
    <div class="mobile-header">
        ...
        <div class="mobile-sort">
            <button class="mobile-sort-btn" onclick="toggleSortDropdown()">
                Sort by
            ...
            <div class="sort-dropdown" id="sortDropdown">
                <div class="sort-option selected" data-value="relevance">Relevance</div>
                ...
                <div class="sort-option" data-value="rating">Customer Rating</div>
                <div class="sort-option" data-value="newest">Newest First</div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkByNameAndValue(name, value) {
        ...
        value.split('|').forEach(val => {
            let selector = `input[type="checkbox"][name="${name}"][value="${val}"]`;
