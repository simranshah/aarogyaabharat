                ...
                <div class="blog_text">
                    ...
                    <div class="blog_tag_name">
                        <ul>
                            ...
                            <li><a href="https://wa.me/?text={{ urlencode('Check out this blog: ' . $oneBlog->title . ' ' . route('blog.details', $oneBlog->slug)) }}"><img src="{{asset('front/images/ri_share-line.svg')}}" alt="ri_share-line"></a></li>
                        </ul>
