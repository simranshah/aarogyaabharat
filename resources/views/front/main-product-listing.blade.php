                ...
                @foreach ($category->products as $product)
                      ...
                      {{ Str::limit($product->name, 40) }}
                              ...
                              @endif
                                ...
                                <div class="frame-25">
                                  <div class="frame-26">
                                    <div class="text-wrapper-15" onclick="addToCart({{ $product->id }})" data-id="{{ $product->id }}">Add to cart</div>
                                  </div>
                                </div>
                              </div>
            @endforeach
...
<div class="recent-product-recently-viewed recent-products">
  ...
  <div class="div-3" style="margin-top: 20px; margin-bottom: 20px;">
...
by the seated occupant turning the rear wheels by hand or electric propulsion by motors.
      ...
      <p class="text-wrapper-58">
        <span class="text-wrapper-59">A wheelchair is a chair fitted with wheels. The device comes in variations allowing either manual
propulsion by the seated occupant turning the rear wheels by hand or electric propulsion by motors. A
