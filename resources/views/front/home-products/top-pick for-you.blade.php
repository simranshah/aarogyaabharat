@if(isset($topPickForYouProducts) && !empty($topPickForYouProducts))
<section class="product_Part">
    <div class="container">
        <div class="titlePart">
            <h4>Top Pick For You </h4>
            <a href="{{ route('products.top.pick.for.you')}}">View All <img src="{{ asset('front/images/orange_arrow.svg') }}" alt="View All"> </a>
        </div>
        <div class="rowMob">
            <div class="product_slider getprogressWidth arrowOnProgress">
                @foreach ($topPickForYouProducts as $product)
