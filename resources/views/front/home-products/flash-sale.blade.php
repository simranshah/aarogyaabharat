@if(isset($flashSaleProducts) && !empty($flashSaleProducts))
<section class="product_Part">
    <div class="container">
        <div class="titlePart">
            <h4>Flash Sale</h4>
            <a href="{{ route('products.flash.sale')}}">View All <img src="{{ asset('front/images/orange_arrow.svg') }}" alt="View All"> </a>
        </div>
        <div class="rowMob">
