@if(isset($bestSellingProducts) && !empty($bestSellingProducts))
<section class="product_Part">
    <div class="container">
        <div class="titlePart">
            <h4>Best Selling Products</h4>
            <a href="{{ route('products.best.sellers')}}">View All <img src="{{ asset('front/images/orange_arrow.svg') }}" alt="View All"> </a>
        </div>
        <div class="rowMob">
