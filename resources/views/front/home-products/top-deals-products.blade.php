@if(isset($topDealsProducts) && !empty($topDealsProducts))
<section class="product_Part">
    <div class="container">
        <div class="titlePart">
            <h4>Top Deals Products</h4>
            <a href="{{ route('products.top.deals')}}">View All <img src="{{ asset('front/images/orange_arrow.svg') }}" alt="View All"> </a>
        </div>
        <div class="rowMob">
            <div class="product_slider getprogressWidth arrowOnProgress">
                @foreach ($topDealsProducts as $product)
