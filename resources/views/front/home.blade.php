...
@section('content')
                        ...
                        @if ($loop->first)
                            <div class="bannerBlock">
                                <a href="{{ $banner->link }}" target="_blank">
                                    <img class="bannerImage" src="{{ asset('storage/' . $banner->image) }}"
        ...
        <div class="container">
            ...
            <div class="why_arogya_bharat_all_box">
                <div class="why_arogya_bharat_box">
                    <div class="arogya_icon"><img src="{{ asset('front/images/Client_Centric_Approach.svg') }}"
                            alt="Client_Centric_Approach" /></div>
                ...
                <div class="why_arogya_bharat_box">
                    <div class="arogya_icon"><img src="{{ asset('front/images/well_equipped.svg') }}"
                            alt="well_equipped" /></div>
                    <div class="why_arogya_bharat_text">
                ...
                <div class="why_arogya_bharat_box">
                    <div class="arogya_icon"><img src="{{ asset('front/images/skilled_team.svg') }}"
                            alt="skilled_team" /></div>
                    <div class="why_arogya_bharat_text">
                ...
                <div class="why_arogya_bharat_box">
                    <div class="arogya_icon"><img src="{{ asset('front/images/wide_distribution_network.svg') }}"
                            alt="wide_distribution_network" /></div>
                    <div class="why_arogya_bharat_text">
                ...
                <div class="why_arogya_bharat_box">
                    <div class="arogya_icon"><img src="{{ asset('front/images/Work-Ethics.svg') }}" alt="Work-Ethics" />
                    </div>
                    <div class="why_arogya_bharat_text">
                ...
                <div class="why_arogya_bharat_box">
                    <div class="arogya_icon"><img src="{{ asset('front/images/delivery-van.svg') }}"
                            alt="delivery-van" /></div>
                    <div class="why_arogya_bharat_text">
                        ...
                        @foreach ($blogs as $blog)
                            <div class="our_blog_box">
                                ...
                                <div class="blog_text" style="height: 128px;">
                                    <div class="text_one">
                                        <h2><a href="{{ route('blog.details', ['slug' => $blog->slug]) }}">{{ $blog->title }}
                                            </a></h2>
                                    ...
                                    <div class="blog_tag_name">
                                        <ul>
                                            ...
                                            <li class="blogview">
                                                <img src="{{ asset('front/images/carbon_view.svg') }}"
                                                    alt="carbon_view" />
                                                <p>{{ $blog->views }}</p>
                                            </li>
                                            <li><a
                                                    href="https://wa.me/?text={{ urlencode('Check out this blog: ' . $blog->title . ' ' . route('blog.details', $blog->slug)) }}"><img
                                                        src="{{ asset('front/images/ri_share-line.svg') }}"
                                                        alt="{{ $blog->title }}"></a></li>
                                        </ul>
                                        <a href="{{ route('blog.details', ['slug' => $blog->slug]) }}"
                                            class="blogreadnow">Read Now</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    @endif
    @if (isset($aboutAarogyaBharat) &&
            !empty($aboutAarogyaBharat) &&
            isset($aboutAarogyaBharat->cms) &&
            !empty($aboutAarogyaBharat->cms))
        <section class="about_aarogya_bharat">
            <div class="container">
                {{-- <div class="about_aarogya_title"><h2>About Aarogya Bharat</h2></div> --}}
                <div class="about_aarogya_title">
                    <h1>{{ $aboutAarogyaBharat->cms->title }}</h1>
                </div>
    ...
    <div class="popup-overlay" id="logoutPopup5" style="display: none;">
        <div class="popup">
            <button class="close-btn"
                onclick="document.getElementById('logoutPopup5').style.display='none';">&times;</button>
            ...
            <div class="popup-buttons">
                <button class="btn yes-btn"
                    onclick="document.getElementById('logoutPopup5').style.display='none';">Yes</button>
    ...
    <script>
        ...
        function checkGetInTouchPopupCookie() {
            ...
            for (let i = 0; i < cookies.length; i++) {
                ...
                // Check if cookie starts with our name (might have other attributes)
                if (cookie.indexOf("getInTouchPopupClosed=") === 0) {
