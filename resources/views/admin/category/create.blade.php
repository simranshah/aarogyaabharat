                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><small>Create Category</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="categoryForm" method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="descriptation" class="form-control @error('descriptation') is-invalid @enderror" id="descriptation" placeholder="Descriptation">{{ old('descriptation') }}</textarea>
                                    @error('descriptation')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
